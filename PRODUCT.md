...
- A Today view for tonight’s dinner. When dinner is still open, the hero asks what sounds good and offers one Choose dinner action. Choosing a recipe opens a center-snap recipe field with a fixed decision tray; List remains a first-class alternative. Make it a meal review covers eaters, extra portions, and an optional side. Confirm writes the dinner through the existing meal save; it never saves from the picker. Breakfast/lunch stay under Also today, with Plan & shop shortcuts, Help, handoff, and household tools remaining available without sitting in the daily loop.
